...
void toi_uu(char *str)
{
int i,j;
char *newStr;
newStr= malloc(100*sizeof(char));
i=0;
while(str[i] == ' ')i++;
newStr=str+i;
...
void makeDict(int size){
  ...
  fData=fopen("dict.txt","w");
  for ( i = 0; i < size; ++i)
  {
    word = make_word(rand()%10+4);
    //word = make_word(rand()%10+10);
    mean = make_word(7);
    fprintf(fData, "%s\t%s\n", word,mean);
    free(word);
  }
...
void banner()
{
	printf("\n\n\n");
	printf("*********************************************************\n");
	printf("**             Welcome this my programming             **\n");
	printf("**                  Nhom 9 Cadvance                    **\n");
	printf("**                   Le Dinh Minh                      **\n");
	printf("**                   Ha Ngoc Binh                      **\n");
	printf("**                   Hoang The Toan                    **\n");
	printf("**                   Bui Duong Tan                     **\n");
	printf("*********************************************************\n");
	printf("\n\n\n");
}
void menu()
{
  printf("\n\n\n");
	...
	printf("**  6) Load data                                       **\n");	
	printf("**  7) Generate a randomize dictionary                 **\n");	
	printf("**  0) Exit                                            **\n");
	printf("*********************************************************\n");
	printf("\n\n\n");
}
...
void goodbye()
{
	printf("\n\n\n");
	printf("*********************************************************\n");
	printf("**    Cam on cac ban da su dung chuong trinh ^_^       **\n");
